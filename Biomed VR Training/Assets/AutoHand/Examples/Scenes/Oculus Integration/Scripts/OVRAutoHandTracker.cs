...
namespace Autohand.Demo{
    ...
    public class OVRAutoHandTracker : MonoBehaviour{
        ...
        void Start(){
            ...
            followPosition = hand.follow;
            followRotation = hand.follow;
            lastMoveTo = moveTo.transform.position;
            moveTo.transform.position = followPosition.position;
            moveTo.transform.rotation = followRotation.rotation;
            hand.follow = moveTo;
