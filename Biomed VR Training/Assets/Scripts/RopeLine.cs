...
public class RopeLine : MonoBehaviour
{
    ...
    public float resolution = 0.025f;
    ...
    private void DisplayRope()
    {
        ...
        float ropeWidthTemp = ropeWidth;

        lineRenderer.startWidth = ropeWidthTemp;
        lineRenderer.endWidth = ropeWidthTemp;
        ...
        //Get the positions
        BezierCurve.GetBezierCurve(A, B, C, D, allRopeSections, resolution);
