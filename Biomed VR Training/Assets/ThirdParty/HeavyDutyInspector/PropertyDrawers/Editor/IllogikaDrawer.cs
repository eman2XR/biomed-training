...
namespace HeavyDutyInspector
{
	...
	public class IllogikaDrawer : PropertyDrawer {
		...
		public void DrawDefaultGUIWithoutLabel(Rect position, SerializedProperty prop)
		{
			switch(prop.propertyType)
			{
				case SerializedPropertyType.Boolean:
					{
						...
						bool value = EditorGUI.Toggle(position, prop.boolValue);
				...
				case SerializedPropertyType.Color:
					{
						EditorGUI.BeginChangeCheck();
						Color value = EditorGUI.ColorField(position, prop.colorValue);
						if(EditorGUI.EndChangeCheck())
				...
				case SerializedPropertyType.Float:
					{
						EditorGUI.BeginChangeCheck();
						float value = EditorGUI.FloatField(position, prop.floatValue);
						if(EditorGUI.EndChangeCheck())
				...
				case SerializedPropertyType.Integer:
					{
						EditorGUI.BeginChangeCheck();
						int value = EditorGUI.IntField(position, prop.intValue);
						if(EditorGUI.EndChangeCheck())
							prop.intValue = value;
					}
					break;
				case SerializedPropertyType.ObjectReference:
					{
						...
						Object value = EditorGUI.ObjectField(position, prop.objectReferenceValue, type, true);
						if(EditorGUI.EndChangeCheck())
				...
				case SerializedPropertyType.Enum:
					{
						EditorGUI.BeginChangeCheck();
						int value = EditorGUI.Popup(position, prop.enumValueIndex, prop.enumDisplayNames);
						if(EditorGUI.EndChangeCheck())
				...
				case SerializedPropertyType.LayerMask:
					{
						EditorGUI.BeginChangeCheck();
						int value = EditorGUI.MaskField(position, prop.intValue, UnityEditorInternal.InternalEditorUtility.layers);
						if(EditorGUI.EndChangeCheck())
							prop.intValue = value;
					}
					break;
				case SerializedPropertyType.AnimationCurve:
					{
						EditorGUI.BeginChangeCheck();
						AnimationCurve value = EditorGUI.CurveField(position, prop.animationCurveValue);
						if(EditorGUI.EndChangeCheck())
				...
				case SerializedPropertyType.Vector2:
					{
						...
						position.x += 12;
						position.width -= 12;
						float[] values = new float[] { prop.vector2Value.x, prop.vector2Value.y };
				...
				case SerializedPropertyType.Vector3:
					{
						...
						position.x += 12;
						position.width -= 12;
						float[] values = new float[] { prop.vector3Value.x, prop.vector3Value.y, prop.vector3Value.z };
				...
				case SerializedPropertyType.Vector4:
					{
						...
						position.x += 12;
						position.width -= 12;
						float[] values = new float[] { prop.vector4Value.x, prop.vector4Value.y, prop.vector4Value.z, prop.vector4Value.w };
						EditorGUI.MultiFloatField(position, new GUIContent[] { new GUIContent("x"), new GUIContent("y"), new GUIContent("z"), new GUIContent("w") }, values);
						if(EditorGUI.EndChangeCheck())
							prop.vector4Value = new Vector4(values[0], values[1], values[2], values[4]);
					}
					break;
				case SerializedPropertyType.Rect:
					{
						...
						position.x += 12;
						position.width -= 12;
						float[] values = new float[] { prop.rectValue.x, prop.rectValue.y, prop.rectValue.width, prop.rectValue.height };
						EditorGUI.MultiFloatField(position, new GUIContent[] { new GUIContent("x"), new GUIContent("y"), new GUIContent("w"), new GUIContent("h") }, values);
						if(EditorGUI.EndChangeCheck())
							prop.rectValue = new Rect(values[0], values[1], values[2], values[4]);
					}
					break;
				case SerializedPropertyType.Quaternion:
					{
						...
						position.x += 12;
						position.width -= 12;
						float[] values = new float[] { prop.quaternionValue.eulerAngles.x, prop.quaternionValue.eulerAngles.y, prop.quaternionValue.eulerAngles.z };
						EditorGUI.MultiFloatField(position, new GUIContent[] { new GUIContent("x"), new GUIContent("y"), new GUIContent("z") }, values);
						if(EditorGUI.EndChangeCheck())
							prop.quaternionValue = Quaternion.Euler(values[0], values[1], values[2]);
					}
					break;
				default:
					break;
		...
		protected virtual void OnNamedMonoBehaviourGUI(Rect position, SerializedProperty property, GUIContent label, System.Type scriptType, int rightOffset)
		{
			...
			if(property.hasMultipleDifferentValues)
			{
				...
				Object temp = EditorGUI.ObjectField(position, EditorGUIUtility.Load(Constants.UNION_PATH), scriptType, true);
